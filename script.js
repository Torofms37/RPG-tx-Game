...
function sellWeapon() {
  if (inventory.length > 1) {
      ...
      text.innerText += " In your inventory you have: " + inventory + " In your inventory you have: ";
  } else {
...
function attack() {
  text.innerText = "The " + monsters[fighting].name + " attacks." + text.innerText += " You attack it with your " + weapons[currentWeaponIndex].name + ".";
